...
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py scen01  assumptions 2>&1 | tee $MULTI_RESULT/scen01.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py scen02  assumptions 2>&1 | tee $MULTI_RESULT/scen02.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py scen03  assumptions 2>&1 | tee $MULTI_RESULT/scen03.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py scen04  assumptions 2>&1 | tee $MULTI_RESULT/scen04.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py scen11  assumptions 2>&1 | tee $MULTI_RESULT/scen11.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph01  assumptions 2>&1 | tee $MULTI_RESULT/graph01.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph02  assumptions 2>&1 | tee $MULTI_RESULT/graph02.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph08  assumptions 2>&1 | tee $MULTI_RESULT/graph08.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph09  assumptions 2>&1 | tee $MULTI_RESULT/graph09.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph14  assumptions 2>&1 | tee $MULTI_RESULT/graph14.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph03  assumptions 2>&1 | tee $MULTI_RESULT/graph03.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph04  assumptions 2>&1 | tee $MULTI_RESULT/graph04.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph05  assumptions 2>&1 | tee $MULTI_RESULT/graph05.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph06  assumptions 2>&1 | tee $MULTI_RESULT/graph06.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph07  assumptions 2>&1 | tee $MULTI_RESULT/graph07.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph10  assumptions 2>&1 | tee $MULTI_RESULT/graph10.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph11  assumptions 2>&1 | tee $MULTI_RESULT/graph11.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph12  assumptions 2>&1 | tee $MULTI_RESULT/graph12.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py graph13  assumptions 2>&1 | tee $MULTI_RESULT/graph13.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py scen05  assumptions 2>&1 | tee $MULTI_RESULT/scen05.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py scen06  assumptions 2>&1 | tee $MULTI_RESULT/scen06.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py scen07  assumptions 2>&1 | tee $MULTI_RESULT/scen07.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py scen08  assumptions 2>&1 | tee $MULTI_RESULT/scen08.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py scen09  assumptions 2>&1 | tee $MULTI_RESULT/scen09.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py scen10  assumptions 2>&1 | tee $MULTI_RESULT/scen10.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py TUD200.1  assumptions 2>&1 | tee $MULTI_RESULT/TUD200.1.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py TUD200.2  assumptions 2>&1 | tee $MULTI_RESULT/TUD200.2.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py TUD200.3  assumptions 2>&1 | tee $MULTI_RESULT/TUD200.3.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py TUD200.4  assumptions 2>&1 | tee $MULTI_RESULT/TUD200.4.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py TUD200.5  assumptions 2>&1 | tee $MULTI_RESULT/TUD200.5.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py TUD916.1  assumptions 2>&1 | tee $MULTI_RESULT/TUD916.1.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py TUD916.2  assumptions 2>&1 | tee $MULTI_RESULT/TUD916.2.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py TUD916.3  assumptions 2>&1 | tee $MULTI_RESULT/TUD916.3.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py TUD916.4  assumptions 2>&1 | tee $MULTI_RESULT/TUD916.4.log
# ./runlim -r $TO -s $MO  python3 -u pairwise_multi.py TUD916.5  assumptions 2>&1 | tee $MULTI_RESULT/TUD916.5.log
